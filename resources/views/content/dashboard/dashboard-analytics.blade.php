    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start">
          ...
          <h2 class="fw-bolder mt-1">{{$data['withdraw'] ?? 0}}</h2>
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start">
          ...
          <h2 class="fw-bolder mt-1">{{$data['commision'] ?? 0}}</h2>
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start">
          ...
          <h2 class="fw-bolder mt-1">{{$data['users'] ?? 0}}</h2>
          <p class="card-text">Total Commision</p>
        </div>
      </div>
    </div>
    <!-- Subscribers Chart Card ends -->
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start">
          ...
          <h2 class="fw-bolder mt-1">{{$data['products'] ?? 0}}</h2>
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start">
          ...
          <h2 class="fw-bolder mt-1">{{$data['sales'] ?? 0}}</h2>
          <p class="card-text">Sales Volumn</p>
        </div>
      </div>
    </div>
    <!-- Subscribers Chart Card ends -->
    ...
    <div class="col-lg-4 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start">
          ...
          <h2 class="fw-bolder mt-1">{{$data['order'] ?? 0}}</h2>
