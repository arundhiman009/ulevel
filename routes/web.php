...
Route::group(['prefix' => 'form'], function () {
    ...
    Route::get('service', [FormsController::class, 'service'])->name('form-service');
    Route::post('form-store', [FormsController::class, 'store'])->name('form-store');
    Route::get('service_list', [FormsController::class, 'service_list'])->name('form-service_list');
    Route::get('edit-package/{id}', [FormsController::class, 'editPackage'])->name('edit-package');
    Route::post('update-package/{id}', [FormsController::class, 'updatePackage'])->name('update-package');
    Route::delete('delete-package/{id}', [FormsController::class, 'deletePackage'])->name('delete-package');
